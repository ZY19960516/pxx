...
let selectQuery = __webpack_require__(9);
let target = '.weui-sticky';
...
Component({
    ...
    methods: {
        ...
        observerContainer() {
            ...
            this.getContainerRect().then(function (rect) {
                _this3.getRect(target).then(function (contentRect) {
                    ...
                    let containerObserver = _this3.createIntersectionObserver({
                        thresholds: [1],
                        initialRatio: 1
                    });
        ...
        setFixed(top) {
            ...
            let fixed = _containerHeight && height ? top >= height + offsetTop + _relativeTop - _containerHeight && top < offsetTop : top < offsetTop;
